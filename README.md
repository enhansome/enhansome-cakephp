...
* [Awesome PHP](https://github.com/ziadoz/awesome-php) ⭐ 32,647 | 🐛 81 | 📅 2026-07-13
...
* [Synapse plugin](https://github.com/josbeir/cakephp-synapse) ⭐ 8 | 🐛 0 | 🌐 PHP | 📅 2026-08-08 - Expose your application functionality via MCP, with built-in tools and documentation search to help you discover and interact with your app's capabilities.
...
* [AssetCompress plugin](https://github.com/markstory/asset_compress) ⭐ 369 | 🐛 30 | 🌐 PHP | 📅 2025-11-20 - A complete asset manager for CakePHP.
...
* [Authentication plugin](https://github.com/cakephp/authentication) ⭐ 118 | 🐛 3 | 🌐 PHP | 📅 2026-08-05 - Official CakePHP authentication middleware plugin.

* [Authorization plugin](https://github.com/cakephp/authorization) ⭐ 74 | 🐛 0 | 🌐 PHP | 📅 2026-08-04 - Official CakePHP authorization stack.
...
* [IdeHelper plugin](https://github.com/dereuromark/cakephp-ide-helper) ⭐ 189 | 🐛 4 | 🌐 PHP | 📅 2026-08-12 - Helps to make IDE support better by adding annotations to your existing code similar to what baking does to new code.
...
* [DebugKit plugin](https://github.com/cakephp/debug_kit) ⭐ 840 | 🐛 0 | 🌐 PHP | 📅 2026-08-03 - The de-facto standard for debugging.
...
* [CakephpWhoops plugin](https://github.com/dereuromark/cakephp-whoops) ⭐ 14 | 🐛 1 | 🌐 PHP | 📅 2026-06-28 - PHP errors and exceptions for cool kids with [filp/whoops](https://github.com/filp/whoops) ⭐ 13,234 | 🐛 9 | 🌐 PHP | 📅 2026-05-06.
...
* [Chronos](https://github.com/cakephp/chronos) ⭐ 1,362 | 🐛 2 | 🌐 PHP | 📅 2026-08-02 - A simple standalone DateTime API extension (successor of Carbon).
...
* [Markup plugin](https://github.com/dereuromark/cakephp-markup) ⭐ 3 | 🐛 0 | 🌐 PHP | 📅 2026-07-09 - Allows to use PHP or JS based syntax highlighting.

### Migration

*Plugins and resources around migration and upgrading.*

* [Migrations plugin](https://github.com/cakephp/migrations) ⭐ 134 | 🐛 6 | 🌐 PHP | 📅 2026-08-03 - (DB) Migration plugin.
...
* [Shim plugin](https://github.com/dereuromark/cakephp-shim) ⭐ 40 | 🐛 1 | 🌐 PHP | 📅 2026-08-02 - A plugin containing useful shims and improvements as basis for your application.
...
* [DatabaseBackup plugin](https://github.com/mirko-pagliai/cakephp-database-backup) ⭐ 24 | 🐛 1 | 🌐 PHP | 📅 2026-08-05 - A plugin to export, import and manage database backups. Currently, the plugin supports MySQL, PostgreSQL and SQLite databases.
...
* [Icings/Menu plugin](https://github.com/icings/menu) ⭐ 12 | 🐛 4 | 🌐 PHP | 📅 2024-06-19 - A [KnpMenu](https://github.com/KnpLabs/KnpMenu) ⭐ 1,395 | 🐛 24 | 🌐 PHP | 📅 2025-12-09 seasoned menu plugin for CakePHP.
...
* [Mercure plugin](https://github.com/josbeir/cakephp-mercure) ⭐ 4 | 🐛 1 | 🌐 PHP | 📅 2026-02-25 - Push real-time updates to clients using the Mercure protocol.
...
* [Queue plugin](https://github.com/cakephp/queue) ⭐ 36 | 🐛 10 | 🌐 PHP | 📅 2026-08-08 - CakePHP core queue system for the [php-queue](https://php-enqueue.github.io) queue library.
...
* [CakeDC/Api plugin](https://github.com/CakeDC/cakephp-api) ⭐ 61 | 🐛 7 | 🌐 PHP | 📅 2026-04-30 - All-in-one solution to provide a complete API. It includes versioning, renderers, CRUD, authentication, extensions (paginate, filter, HATEOAS), and much more.
...
* [Cake/Elasticsearch plugin](https://github.com/cakephp/elastic-search) ⭐ 85 | 🐛 0 | 🌐 PHP | 📅 2026-08-02 - Alternative ORM using [Elasticsearch](https://www.elastic.co/) as its backend.
...
* [BootstrapUI plugin](https://github.com/friendsofcake/bootstrap-ui) ⭐ 351 | 🐛 0 | 🌐 PHP | 📅 2026-07-11 - Bootstrap 4/5 integration.
...
* [Bake plugin](https://github.com/cakephp/bake) ⭐ 112 | 🐛 0 | 🌐 PHP | 📅 2026-08-03 - Provides code generation functionality.
...
* [CakePHP CodeSniffer rules](https://github.com/cakephp/cakephp-codesniffer) ⭐ 232 | 🐛 5 | 🌐 PHP | 📅 2026-07-08 - The official CakePHP CS rules.
...
* [CakephpFixtureFactories plugin](https://github.com/dereuromark/cakephp-fixture-factories) ⭐ 2 | 🐛 2 | 🌐 PHP | 📅 2026-05-28 - Create your fixtures dynamically on a test basis, accelerate the writing and maintenance of your tests.
...
IDE specific compatibility information and tips can be found [here](https://github.com/dereuromark/cakephp-ide-helper/wiki#ide-support-and-tips) ⭐ 189 | 🐛 4 | 🌐 PHP | 📅 2026-08-12.
...
* [baserCMS](https://github.com/baserproject/basercms) ⭐ 194 | 🐛 101 | 🌐 PHP | 📅 2026-08-11 - This is a website development framework with RESTful APIs. Installable as a plugin for CakePHP.

### Demo

*Web-based (demo) applications and tools.*

* [RealWorld](https://github.com/gothinkster/cakephp-realworld-example-app) ⚠️ Archived - Example CakePHP codebase containing real world examples (CRUD, auth, advanced patterns and more) that adheres to the [RealWorld](https://github.com/gothinkster/realworld-example-apps) ⭐ 84,078 | 🐛 32 | 🌐 TypeScript | 📅 2026-08-12 spec and API.
...
* [Top 10 (and more) core contributors](https://github.com/cakephp/cakephp/graphs/contributors) ⭐ 8,795 | 🐛 27 | 🌐 PHP | 📅 2026-08-07 - Give 'em a hand.
