...
* [Awesome PHP](https://github.com/ziadoz/awesome-php) ⭐ 32,679 | 🐛 87 | 📅 2026-07-13
...
* [Authentication plugin](https://github.com/cakephp/authentication) ⭐ 118 | 🐛 3 | 🌐 PHP | 📅 2026-09-05 - Official CakePHP authentication middleware plugin.
...
* [IdeHelper plugin](https://github.com/dereuromark/cakephp-ide-helper) ⭐ 189 | 🐛 5 | 🌐 PHP | 📅 2026-09-04 - Helps to make IDE support better by adding annotations to your existing code similar to what baking does to new code.
...
* [Chronos](https://github.com/cakephp/chronos) ⭐ 1,361 | 🐛 2 | 🌐 PHP | 📅 2026-09-06 - A simple standalone DateTime API extension (successor of Carbon).
...
* [Cake/Elasticsearch plugin](https://github.com/cakephp/elastic-search) ⭐ 86 | 🐛 0 | 🌐 PHP | 📅 2026-08-31 - Alternative ORM using [Elasticsearch](https://www.elastic.co/) as its backend.
...
IDE specific compatibility information and tips can be found [here](https://github.com/dereuromark/cakephp-ide-helper/wiki#ide-support-and-tips) ⭐ 189 | 🐛 5 | 🌐 PHP | 📅 2026-09-04.
...
* [baserCMS](https://github.com/baserproject/basercms) ⭐ 190 | 🐛 87 | 🌐 PHP | 📅 2026-09-04 - This is a website development framework with RESTful APIs. Installable as a plugin for CakePHP.

### Demo

*Web-based (demo) applications and tools.*

* [RealWorld](https://github.com/gothinkster/cakephp-realworld-example-app) ⚠️ Archived - Example CakePHP codebase containing real world examples (CRUD, auth, advanced patterns and more) that adheres to the [RealWorld](https://github.com/gothinkster/realworld-example-apps) ⭐ 84,201 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-26 spec and API.
...
* [Top 10 (and more) core contributors](https://github.com/cakephp/cakephp/graphs/contributors) ⭐ 8,796 | 🐛 27 | 🌐 PHP | 📅 2026-09-06 - Give 'em a hand.
