...
* [Authentication plugin](https://github.com/cakephp/authentication) ⭐ 118 | 🐛 3 | 🌐 PHP | 📅 2026-08-30 - Official CakePHP authentication middleware plugin.

* [Authorization plugin](https://github.com/cakephp/authorization) ⭐ 74 | 🐛 4 | 🌐 PHP | 📅 2026-08-30 - Official CakePHP authorization stack.
...
* [IdeHelper plugin](https://github.com/dereuromark/cakephp-ide-helper) ⭐ 189 | 🐛 4 | 🌐 PHP | 📅 2026-08-23 - Helps to make IDE support better by adding annotations to your existing code similar to what baking does to new code.
...
* [Chronos](https://github.com/cakephp/chronos) ⭐ 1,362 | 🐛 3 | 🌐 PHP | 📅 2026-08-30 - A simple standalone DateTime API extension (successor of Carbon).
...
* [DatabaseBackup plugin](https://github.com/mirko-pagliai/cakephp-database-backup) ⭐ 24 | 🐛 4 | 🌐 PHP | 📅 2026-08-26 - A plugin to export, import and manage database backups. Currently, the plugin supports MySQL, PostgreSQL and SQLite databases.
...
* [Queue plugin](https://github.com/cakephp/queue) ⭐ 36 | 🐛 10 | 🌐 PHP | 📅 2026-08-30 - CakePHP core queue system for the [php-queue](https://php-enqueue.github.io) queue library.
...
* [Cake/Elasticsearch plugin](https://github.com/cakephp/elastic-search) ⭐ 86 | 🐛 1 | 🌐 PHP | 📅 2026-08-30 - Alternative ORM using [Elasticsearch](https://www.elastic.co/) as its backend.
...
* [Bake plugin](https://github.com/cakephp/bake) ⭐ 112 | 🐛 1 | 🌐 PHP | 📅 2026-08-30 - Provides code generation functionality.
...
IDE specific compatibility information and tips can be found [here](https://github.com/dereuromark/cakephp-ide-helper/wiki#ide-support-and-tips) ⭐ 189 | 🐛 4 | 🌐 PHP | 📅 2026-08-23.
...
* [baserCMS](https://github.com/baserproject/basercms) ⭐ 193 | 🐛 87 | 🌐 PHP | 📅 2026-08-28 - This is a website development framework with RESTful APIs. Installable as a plugin for CakePHP.

### Demo

*Web-based (demo) applications and tools.*

* [RealWorld](https://github.com/gothinkster/cakephp-realworld-example-app) ⚠️ Archived - Example CakePHP codebase containing real world examples (CRUD, auth, advanced patterns and more) that adheres to the [RealWorld](https://github.com/gothinkster/realworld-example-apps) ⭐ 84,169 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-26 spec and API.
