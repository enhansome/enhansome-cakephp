...
* [CakeDC/Users plugin](https://github.com/CakeDC/users) ⭐ 522 | 🐛 50 | 🌐 PHP | 📅 2026-08-31 - Complete user management (admin panel, remember me, etc), Social login (FB, Twitter, LinkedIn, Google, Instagram), RBAC, API and more.
...
* [Authentication plugin](https://github.com/cakephp/authentication) ⭐ 118 | 🐛 2 | 🌐 PHP | 📅 2026-09-08 - Official CakePHP authentication middleware plugin.
...
* [IdeHelper plugin](https://github.com/dereuromark/cakephp-ide-helper) ⭐ 189 | 🐛 4 | 🌐 PHP | 📅 2026-09-13 - Helps to make IDE support better by adding annotations to your existing code similar to what baking does to new code.
...
* [CakephpWhoops plugin](https://github.com/dereuromark/cakephp-whoops) ⭐ 14 | 🐛 1 | 🌐 PHP | 📅 2026-06-28 - PHP errors and exceptions for cool kids with [filp/whoops](https://github.com/filp/whoops) ⭐ 13,233 | 🐛 8 | 🌐 PHP | 📅 2026-09-05.
...
* [RuleFlow plugin](https://github.com/skie/rule-flow) ⭐ 1 | 🐛 0 | 🌐 PHP | 📅 2026-09-11 - A plugin that seamlessly transforms server-side validation rules into client-side JSON Logic validation, providing automatic form validation without requiring separate client-side validation code.
...
* [Migrations plugin](https://github.com/cakephp/migrations) ⭐ 134 | 🐛 11 | 🌐 PHP | 📅 2026-09-15 - (DB) Migration plugin.
...
* [Muffin/Trash plugin](https://github.com/usemuffin/trash) ⭐ 85 | 🐛 3 | 🌐 PHP | 📅 2026-03-24 - Soft-delete behavior for CakePHP.
...
* [Queue plugin](https://github.com/cakephp/queue) ⭐ 36 | 🐛 9 | 🌐 PHP | 📅 2026-08-31 - CakePHP core queue system for the [php-queue](https://php-enqueue.github.io) queue library.
...
* [App template](https://github.com/cakephp/app) ⭐ 387 | 🐛 6 | 🌐 PHP | 📅 2026-08-05 - An empty CakePHP project for use with composer.
...
* [Ratings plugin](https://github.com/dereuromark/cakephp-ratings) ⭐ 8 | 🐛 1 | 🌐 PHP | 📅 2026-06-28 - Allows users to rate records and displays ratings.
...
* [Bake plugin](https://github.com/cakephp/bake) ⭐ 112 | 🐛 0 | 🌐 PHP | 📅 2026-08-31 - Provides code generation functionality.
...
IDE specific compatibility information and tips can be found [here](https://github.com/dereuromark/cakephp-ide-helper/wiki#ide-support-and-tips) ⭐ 189 | 🐛 4 | 🌐 PHP | 📅 2026-09-13.
...
* [baserCMS](https://github.com/baserproject/basercms) ⭐ 190 | 🐛 87 | 🌐 PHP | 📅 2026-09-10 - This is a website development framework with RESTful APIs. Installable as a plugin for CakePHP.

### Demo

*Web-based (demo) applications and tools.*

* [RealWorld](https://github.com/gothinkster/cakephp-realworld-example-app) ⚠️ Archived - Example CakePHP codebase containing real world examples (CRUD, auth, advanced patterns and more) that adheres to the [RealWorld](https://github.com/gothinkster/realworld-example-apps) ⭐ 84,215 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-26 spec and API.
...
* [Vue.js demo app](https://github.com/ishanvyas22/cakephpvue-spa) ⭐ 46 | 🐛 4 | 🌐 PHP | 📅 2026-09-12 - A CakePHP + Vue.js single page application skeleton.
