...
* [Awesome PHP](https://github.com/ziadoz/awesome-php) ⭐ 32,660 | 🐛 85 | 📅 2026-07-13
...
* [Authentication plugin](https://github.com/cakephp/authentication) ⭐ 118 | 🐛 3 | 🌐 PHP | 📅 2026-08-17 - Official CakePHP authentication middleware plugin.
...
* [Queue plugin](https://github.com/cakephp/queue) ⭐ 36 | 🐛 10 | 🌐 PHP | 📅 2026-08-17 - CakePHP core queue system for the [php-queue](https://php-enqueue.github.io) queue library.
...
* [Cake/Elasticsearch plugin](https://github.com/cakephp/elastic-search) ⭐ 85 | 🐛 0 | 🌐 PHP | 📅 2026-08-17 - Alternative ORM using [Elasticsearch](https://www.elastic.co/) as its backend.
...
* [RealWorld](https://github.com/gothinkster/cakephp-realworld-example-app) ⚠️ Archived - Example CakePHP codebase containing real world examples (CRUD, auth, advanced patterns and more) that adheres to the [RealWorld](https://github.com/gothinkster/realworld-example-apps) ⭐ 84,113 | 🐛 32 | 🌐 TypeScript | 📅 2026-08-13 spec and API.
...
* [Top 10 (and more) core contributors](https://github.com/cakephp/cakephp/graphs/contributors) ⭐ 8,794 | 🐛 28 | 🌐 PHP | 📅 2026-08-20 - Give 'em a hand.
