...
* [DebugKit plugin](https://github.com/cakephp/debug_kit) ⭐ 839 | 🐛 1 | 🌐 PHP | 📅 2026-09-25 - The de-facto standard for debugging.
...
* [baserCMS](https://github.com/baserproject/basercms) ⭐ 190 | 🐛 90 | 🌐 PHP | 📅 2026-09-25 - This is a website development framework with RESTful APIs. Installable as a plugin for CakePHP.

### Demo

*Web-based (demo) applications and tools.*

* [RealWorld](https://github.com/gothinkster/cakephp-realworld-example-app) ⚠️ Archived - Example CakePHP codebase containing real world examples (CRUD, auth, advanced patterns and more) that adheres to the [RealWorld](https://github.com/gothinkster/realworld-example-apps) ⭐ 84,237 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-26 spec and API.
...
* [Top 10 (and more) core contributors](https://github.com/cakephp/cakephp/graphs/contributors) ⭐ 8,790 | 🐛 19 | 🌐 PHP | 📅 2026-09-25 - Give 'em a hand.
